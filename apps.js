// Verifica se o botão da calculadora existe na página atual antes de rodar
...
// Verifica se o formulário de doação existe antes de rodar
...
if (formDoacao) {
    formDoacao.addEventListener('submit', function(event) {
        ...
        const dadosDoador = {
            ...
            rua: document.getElementById('doador-rua').value, // Agora funcionará com o ID corrigido no HTML
